...
export default function GetStartedPage() {
  ...
  const generateRandomAvatar = async () => {
    ...
    try {
      // Generate random avatar using the provided API
      const randomId = Math.floor(Math.random() * 1000);
      const newAvatarUrl = `https://avatar-placeholder.iran.liara.run/avatars?id=${randomId}`;
        ...
        <Card className="shadow-xl">
          <CardHeader className="text-center pb-6">
            ...
            <CardDescription className="text-lg text-gray-600">
              Tell us about yourself to get started with SkillSwap
            </CardDescription>
          </CardHeader>
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      <FormDescription className="text-xs">
                        This will be your unique identifier on SkillSwap
                      </FormDescription>
                      <FormMessage />
                    </FormItem>
                  )}
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      <FormControl>
                        <textarea 
                          placeholder="Tell us about yourself, your skills, and what you're looking to swap..."
                          className="flex min-h-[100px] w-full rounded-md border border-input bg-background px-3 py-2 text-base ring-offset-background placeholder:text-muted-foreground focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:cursor-not-allowed disabled:opacity-50 md:text-sm resize-none"
                          {...field}
                        />
                      </FormControl>
                      <FormDescription className="text-xs">
                        Optional - Help others understand your skills and interests
                      </FormDescription>
                      <FormMessage />
                    </FormItem>
                  )}
